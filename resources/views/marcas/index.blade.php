...
<div class="container-fluid px-4">
  ...
  <a href="{{ route('marcas.create') }}" class="btn btn-primary mb-4">Agregar nuevo registro</a>
            ...
            <tbody>
                @foreach ($marcas as $marca)
                    <tr>
                        ...
                        <td>{!! $marca->caracteristica->estado ? '<span class="badge bg-primary">Activo</span>' : '<span class="badge bg-danger">Eliminado</span>' !!}</td>
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                @if ($marca->caracteristica->estado)
